# Generated by Django 2.2.16 on 2022-06-14 14:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='post',
            name='image',
            field=models.ImageField(blank=True, help_text='Загрузите картинку', null=True, upload_to='post_image/', verbose_name='Изображение для поста'),
        ),
        ...
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(unique=True, verbose_name='Адрес латиницей'),
        ),
        migrations.AlterField(
            model_name='group',
            name='title',
